/*
  ...
  - You are about to drop the column `duree` on the `film` table. All the data in the column will be lost.
  - Added the required column `durer` to the `film` table without a default value. This is not possible if the table is not empty.
